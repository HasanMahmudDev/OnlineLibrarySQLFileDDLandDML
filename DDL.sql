...
LOG ON
(	Name = 'bookRepositoryDB_Log_1',
	FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL13.SQLEXPRESS\MSSQL\DATA\bookRepositoryDB_Log_1.ldf',
	SIZE = 2MB,
	MAXSIZE = 50MB,
	FILEGROWTH = 1MB
)
...
--/*  Create Function: A scalar valued function (Problem) */
--Insert	
GO
